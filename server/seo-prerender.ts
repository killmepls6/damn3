...
<head>
  ...
  <title>${escapeHtml(metaTitle)} | MangaVerse</title>
...
async function prerenderHomepage(baseUrl: string): Promise<string> {
  ...
  const structuredData = {
    ...
    "name": "MangaVerse",
    "url": baseUrl,
    "description": "Discover and read thousands of manga and manhwa series online. Your ultimate destination for manga discovery.",
    "potentialAction": {
      "@type": "SearchAction",
      "target": {
        "@type": "EntryPoint",
...
<head>
  ...
  <meta name="description" content="Explore thousands of manga and manhwa series with ratings, latest updates, and trending recommendations. Your ultimate destination for manga discovery." />
  ...
  <meta property="og:title" content="MangaVerse - Discover Amazing Manga & Manhwa" />
  <meta property="og:description" content="Explore thousands of manga and manhwa series with ratings, latest updates, and trending recommendations." />
  <meta property="og:site_name" content="MangaVerse" />
  
  <!-- Twitter Card -->
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:title" content="MangaVerse - Discover Amazing Manga & Manhwa" />
  <meta name="twitter:description" content="Explore thousands of manga and manhwa series with ratings, latest updates, and trending recommendations." />
...
<body>
  <div id="root">
    <main>
      <h1>MangaVerse - Discover Amazing Manga & Manhwa</h1>
      <section>
...
<head>
  <meta charset="UTF-8" />
  <title>Browse Manga & Manhwa | MangaVerse</title>
