...
import { History as HistoryIcon, BookOpen, Clock, Trash2 } from "lucide-react";
...
export default function History() {
  ...
  const handleDeleteProgress = (seriesId: string, seriesTitle: string) => {
    if (confirm(`Remove "${seriesTitle}" from your reading history?`)) {
      deleteProgress(seriesId);
      toast({
        title: "History cleared",
        description: `Removed "${seriesTitle}" from your reading history.`,
      });
    }
  };
