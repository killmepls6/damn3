  ...
  return (
    <div className="min-h-screen bg-background w-full overflow-x-hidden">
      <SEO 
        ...
        description="Submit a DMCA takedown notice for copyright infringement. MangaVerse respects intellectual property rights and responds to valid copyright claims."
          ...
          <Card className="bg-card/80 backdrop-blur-md border-border/50">
            ...
            <CardContent className="space-y-3 text-muted-foreground">
              ...
              <div className="bg-muted/20 border border-border/30 rounded-lg p-4 space-y-2">
                <p><strong className="text-foreground">DMCA Agent:</strong> MangaVerse Legal Team</p>
