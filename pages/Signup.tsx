...
import { BookOpen, User, Mail, Camera, Upload } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="flex items-center justify-center p-4 pt-20">
        ...
        <div className="flex flex-col items-center justify-center mb-8">
          ...
          <p className="text-muted-foreground text-center text-sm">Join MangaVerse to start your manga journey</p>
        </div>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              <Button
                ...
                className="w-full h-12 mt-6 bg-gradient-to-r from-primary to-accent hover:from-primary/80 hover:to-accent/80 text-primary-foreground font-medium rounded-lg transition-all duration-200 shadow-lg shadow-primary/30 text-center pt-[12px] pb-[12px]"
              >
          ...
          <div className="text-center">
            <p className="text-sm text-gray-400">
              ...
              <Link href="/login">
                <Button 
                  variant="ghost" 
                  className="p-0 h-auto text-blue-400 underline cursor-pointer font-medium hover:bg-transparent hover:text-blue-400 hover:underline"
                >
                  Login
                </Button>
              </Link>
        ...
        <div className="mt-12 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-4">
            Read Comics, manga, manhwa. Translated swiftly. MangaVerse your ultimate library.
          </p>
