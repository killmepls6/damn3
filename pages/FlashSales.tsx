...
import { Zap, Clock, Percent, ShoppingCart, Coins } from "lucide-react";
                ...
                >
                  ...
                  <div className="p-6 space-y-4">
                    ...
                    <Button
                      ...
                      className="w-full bg-gradient-to-r from-red-500 to-orange-500 hover:from-red-600 hover:to-orange-600 text-white shadow-lg shadow-red-500/25"
                      size="lg"
                    >
