  ...
  return (
    <div className="min-h-screen bg-background w-full overflow-x-hidden">
      <SEO 
        ...
        description="MangaVerse Privacy Policy - Learn how we collect, use, and protect your personal information. Your privacy is our priority."
        ...
        <Card className="bg-card/80 backdrop-blur-md border-border/50 mb-6">
          <CardContent className="p-6 sm:p-8">
            <p className="text-muted-foreground leading-relaxed">
              At MangaVerse, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, 
