...
import { Zap, Plus, Edit, Trash2, ArrowLeft, Clock, Percent, ShoppingBag } from "lucide-react";
...
export default function AdminFlashSales() {
  ...
  const createSaleMutation = useMutation({
    mutationFn: async (data: any) => {
      ...
      const response = await fetch("/api/admin/flash-sales/create", {
        method: "POST",
        headers: {
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-4xl font-bold text-white mb-2">Flash Sales Management</h1>
