...
import { BookOpen, Moon, Sun, Monitor, User, Mail, MapPin, Upload, LogOut, Lock, Loader2, Trophy, Star, Award } from "lucide-react";
          ...
          <div className="space-y-6">
            <Card className="bg-card/80 backdrop-blur-md border-border/50">
              <CardHeader>
                ...
                <CardDescription>
                  Customize how MangaVerse looks and feels
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
