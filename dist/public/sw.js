// MangaVerse Service Worker for Complete Offline Functionality
const CACHE_NAME = 'mangaverse-v1.0.0';
const STATIC_CACHE = 'mangaverse-static-v1.0.0';
const API_CACHE = 'mangaverse-api-v1.0.0';
const IMAGE_CACHE = 'mangaverse-images-v1.0.0';
...
self.addEventListener('install', (event) => {
  console.log('[SW] Installing MangaVerse Service Worker...');
...
self.addEventListener('activate', (event) => {
  console.log('[SW] Activating MangaVerse Service Worker...');
...
async function handleNavigationRequest(request) {
  try {
    ...
    return new Response(`
      ...
      <html>
        <head>
          <title>MangaVerse - Offline</title>
...
console.log('[SW] MangaVerse Service Worker loaded successfully');